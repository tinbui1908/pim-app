...
class SampleService extends BaseService {
	...
	SampleGetResponse(): Observable<StrictHttpResponse<Array<SampleDto>>> {
		...
		let __body: any = null;
		let req = new HttpRequest<any>('GET', this.rootUrl + `/api/Sample`, __body, {
			headers: __headers,
			params: __params,
			responseType: 'json'
		});
	...
	SamplePutResponse(sample: SampleDto): Observable<StrictHttpResponse<SampleDto>> {
		...
		let __body: any = null;
		__body = sample;
		let req = new HttpRequest<any>('PUT', this.rootUrl + `/api/Sample`, __body, {
			headers: __headers,
			params: __params,
			responseType: 'json'
		});
	...
	SamplePostResponse(sample: SampleDto): Observable<StrictHttpResponse<SampleDto>> {
		...
		let __body: any = null;
		__body = sample;
		let req = new HttpRequest<any>('POST', this.rootUrl + `/api/Sample`, __body, {
			headers: __headers,
			params: __params,
			responseType: 'json'
		});
	...
	SampleGet_1Response(id: number): Observable<StrictHttpResponse<SampleDto>> {
		...
		let req = new HttpRequest<any>('GET', this.rootUrl + `/api/Sample/${id}`, __body, {
			headers: __headers,
			params: __params,
			responseType: 'json'
		});
	...
	SampleDeleteResponse(id: number): Observable<StrictHttpResponse<null>> {
		...
		let req = new HttpRequest<any>('DELETE', this.rootUrl + `/api/Sample/${id}`, __body, {
			headers: __headers,
			params: __params,
			responseType: 'json'
		});
